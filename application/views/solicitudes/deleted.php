    ...
    <div class="map_container">
      ...
      <div class="container login">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <h2 class="heading mb-12">Solicitud Eliminada</h2>
            <div class="sub-heading">
              <p class="mb-12">La solicutud se ha eliminado satisfactoriamente.</p>
              <p class="mb-12">
                <a class="btn btn-success btn-lg pb_btn-pill smoothscroll" href="<?php echo base_url(); ?>solicitudes">
