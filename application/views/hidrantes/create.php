<section class="pb_cover_v3 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light" id="section-home">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <h2 class="heading mb-3">Creacion de Hidrantes</h2>
            ...
            <p class="mb-12">Para crear un nuevo hidrante se debe seguir el siguiente proceso:</p>
                <ol>
                  ...
                  <li>Una vez la solicitud se marca como completada, el hidrante es agregado a la base de datos y posteriormente se muestra en el mapa en el mapa.</li>
                </ol>
            </div>
          </div>
        </div>
